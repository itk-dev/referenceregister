...
![Front page](../images/manager/front-page.png)
...
![Tilføj registrering](../images/manager/entry-add.png)
![Tilføj registrering](../images/manager/entry-add-filled-invalid.png)
![Tilføj registrering](../images/manager/entry-add-invalid-identifier.png)

Systemet tjekker at identifikationen (id'et) er gyldig.

![Tilføj registrering](../images/manager/entry-add-filled.png)
![Registrering tilføjet](../images/manager/entry-add-succes.png)

## Fjern registrering

En leder kan under <AppLink href="/remove">Fjern registrering</AppLink> fjerne registreringer:

![Fjern registrering](../images/manager/entry-remove.png)
![Fjern registrering](../images/manager/entry-remove-filled.png)
![Fjern registrering](../images/manager/entry-removed.png)
